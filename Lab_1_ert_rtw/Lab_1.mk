###########################################################################
## Makefile generated for Simulink model 'Lab_1'. 
## 
## Makefile     : Lab_1.mk
## Generated on : Mon Oct 05 17:32:13 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Lab_1.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/John/home/3K04/3K04-pacemaker-firmware
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Lab_1_comp.rsp
CMD_FILE                  = Lab_1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Lab_1.elf
...
DEFINES_STANDARD = -DMODEL=Lab_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o Lab_1.o Lab_1_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Lab_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Lab_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Lab_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Lab_1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Lab_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Lab_1.o : $(START_DIR)/Lab_1_ert_rtw/Lab_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Lab_1_data.o : $(START_DIR)/Lab_1_ert_rtw/Lab_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
